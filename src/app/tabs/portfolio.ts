export const port = {
    text: [
        ...
        "In 2006-2007 Designed and developed client-server application on Delphi 6 using C++. Server had friendly UI as well as console management and was controlling and monitoring clients.",
        "Functionality:",
        " * Clients had total and stealthy control over the object PC's;",
        " * It was controlling inputs from hardware components: microphone, camera, keyboard, mouse and monitor. Could initiate keyboard and mouse actions;",
        " * File system management: directory tree of object PC on server side and file transfer in both directions. Listening to important folder structure changes;",
        " * Monitoring and editing windows registry and windows processes;",
        " * Software was able to find malware and clean the object computer to ensure its own smooth functioning and avoid possible reinstallation of the OS.",
